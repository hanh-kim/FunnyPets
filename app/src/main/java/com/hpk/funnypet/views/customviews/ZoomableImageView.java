...
public class ZoomableImageView extends AppCompatImageView implements OnScaleGestureListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        autoResetMode = fromInt(values.getInt(R.styleable.ZoomageView_zoomage_autoResetMode, AutoResetMode.UNDER));
    ...
    @AutoResetMode
    private int fromInt(final int value) {
        switch (value) {
            case AutoResetMode.OVER:
                return AutoResetMode.OVER;
            case AutoResetMode.ALWAYS:
                return AutoResetMode.ALWAYS;
            case AutoResetMode.NEVER:
                return AutoResetMode.NEVER;
            default:
                return AutoResetMode.UNDER;
        }
    }
